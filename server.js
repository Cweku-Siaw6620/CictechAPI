...
mongoose.connect('mongodb+srv://cictech_electronics:cictechInventory@cictechapi.fsyh2.mongodb.net/?appName=cictechApi')
.then(()=>{
    console.log("connected to Cictech-Inventory database successfully");
    app.listen(port, ()=>{
        console.log('Cictech API is running on port ' + port);
    })
}).catch((error)=>{
    console.log("Error connecting to Cictech-Inventory:", error);
})